...
public class WeatherSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (DeviceUtils.isPackageInstalled(WEATHER_SERVICE_PACKAGE, pm)) {
    ...
    private boolean isOmniJawsServiceInstalled() {
        return DeviceUtils.isPackageInstalled(WEATHER_SERVICE_PACKAGE, getActivity().getPackageManager());
    }
