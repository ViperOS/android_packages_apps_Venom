...
package com.viper.venom.bubbletab;
...
public class BubbleTab extends LinearLayout {
    ...
    static class Setting {
        ...
        public Setting(Context context, AttributeSet attrs) {
            ...
            if (array != null) {
                selectedColor = array.getColor(R.styleable.BubbleTab_bubbleTab_selectedColor, context.getColor(R.color.theme_accent));
                unselectedColor = array.getColor(R.styleable.BubbleTab_bubbleTab_unselectedColor, context.getColor(R.color.theme_accent));
                circleColor = array.getInt(R.styleable.BubbleTab_bubbleTab_circleColor, context.getColor(R.color.theme_accent));
